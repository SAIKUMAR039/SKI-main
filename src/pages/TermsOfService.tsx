  ...
  const sections = [
    {
      ...
      content: [
        'SKI Creative Lab provides digital marketing, creative design, and AI services',
    ...
    },
    {
      ...
      content: [
        ...
        'SKI retains rights to work samples for portfolio and marketing purposes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-ski-gray via-white to-ski-gray">
      ...
      <section className="pt-24 sm:pt-28 lg:pt-32 pb-8 sm:pb-12 lg:pb-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              <FileText className="w-4 h-4 sm:w-5 sm:h-5 text-ski-accent" />
              <span className="text-ski-accent font-semibold text-xs sm:text-sm lg:text-base">Legal Terms</span>
            </motion.div>
      ...
      <section className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-ski-black mb-6">Agreement</h2>
            <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
              <p>
                By engaging SKI Creative Lab for services, you agree to these Terms of Service. These terms apply to all services provided by SKI Creative Lab, including but not limited to digital marketing, graphic design, web development, and AI automation services.
              </p>
              <p>
            ...
            {sections.map((section, index) => (
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-ski-black">{section.title}</h3>
                </div>
                <ul className="space-y-3 text-gray-700">
                  {section.content.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-r from-ski-accent to-orange-500 rounded-full mt-2 flex-shrink-0" />
          ...
          <motion.div
            ...
            className="mt-12 sm:mt-16 bg-gradient-to-r from-ski-accent/10 to-orange-500/10 rounded-2xl p-6 sm:p-8 border border-ski-accent/20"
          >
            <h3 className="text-xl sm:text-2xl font-bold text-ski-black mb-4">Additional Terms</h3>
            <div className="space-y-4 text-gray-700">
              <div>
                <h4 className="font-semibold text-ski-black mb-2">Project Cancellation</h4>
              ...
              <div>
                <h4 className="font-semibold text-ski-black mb-2">Dispute Resolution</h4>
              ...
              <div>
                <h4 className="font-semibold text-ski-black mb-2">Governing Law</h4>
          ...
          >
            <h3 className="text-xl sm:text-2xl font-bold text-ski-black mb-4">Contact Information</h3>
