    ...
    <div className="min-h-screen bg-gradient-to-br from-ski-gray via-white to-ski-gray">
      ...
      <section className="pt-24 sm:pt-28 lg:pt-32 pb-8 sm:pb-12 lg:pb-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-ski-accent" />
              <span className="text-ski-accent font-semibold text-xs sm:text-sm lg:text-base">Privacy & Security</span>
            </motion.div>
      ...
      <section className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-ski-black mb-6">Introduction</h2>
            <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
              <p>
                SKI Creative Lab ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, use our services, or interact with us.
              </p>
              <p>
