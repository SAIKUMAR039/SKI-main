    ...
    <div className="min-h-screen bg-gradient-to-br from-skizen-gray via-white to-skizen-gray">
      ...
      <section className="pt-24 sm:pt-28 lg:pt-32 pb-8 sm:pb-12 lg:pb-16 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10 sm:opacity-20">
          ...
          <div className="absolute bottom-10 sm:bottom-20 right-5 sm:right-10 w-40 h-40 sm:w-60 sm:h-60 lg:w-80 lg:h-80 bg-gradient-to-br from-skizen-black/20 to-gray-800/20 rounded-full blur-2xl sm:blur-3xl" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-skizen-accent/10 to-orange-500/10 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 rounded-full border border-skizen-accent/20 mb-4 sm:mb-6 lg:mb-8"
            >
              <Send className="w-4 h-4 sm:w-5 sm:h-5 text-skizen-accent" />
              <span className="text-skizen-accent font-semibold text-xs sm:text-sm lg:text-base">Get In Touch</span>
            </motion.div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
            ...
            >
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-skizen-black mb-4 sm:mb-6 lg:mb-8">Send us a message</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-skizen-accent focus:border-transparent transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed bg-white/50 backdrop-blur-sm text-sm sm:text-base"
                ...
                >
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    disabled={isSubmitting}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-skizen-accent focus:border-transparent transition-all duration-200 resize-none disabled:opacity-50 disabled:cursor-not-allowed bg-white/50 backdrop-blur-sm text-sm sm:text-base"
                ...
                <motion.button
                  ...
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-skizen-black to-gray-800 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-medium flex items-center justify-center gap-2 hover:from-skizen-accent hover:to-orange-500 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl text-sm sm:text-base"
                  initial={{ opacity: 0, y: 20 }}
                  animate={inView ? { opacity: 1, y: 0 } : {}}
            ...
            >
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 xl:p-12 border border-gray-200/50 shadow-2xl">
                <motion.h3 
                  className="text-xl sm:text-2xl lg:text-3xl font-bold text-skizen-black mb-4 sm:mb-6"
                  initial={{ opacity: 0, y: 20 }}
                  animate={inView ? { opacity: 1, y: 0 } : {}}
                  transition={{ duration: 0.4, delay: 0.3 }}
                >
                ...
                <div className="space-y-4 sm:space-y-6">
                  {contactInfo.map((info, index) => (
                    <motion.a
                      ...
                      className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-skizen-gray/50 to-white/50 rounded-lg sm:rounded-xl hover:shadow-lg transition-all duration-300 group border border-gray-200/50"
                      initial={{ opacity: 0, x: 20 }}
                      animate={inView ? { opacity: 1, x: 0 } : {}}
                      transition={{ duration: 0.4, delay: 0.5 + index * 0.1 }}
                    >
                      <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-r from-skizen-accent to-orange-500 rounded-lg sm:rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 flex-shrink-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-skizen-black font-semibold text-sm sm:text-base lg:text-lg break-words">
                          {info.value}
                        </div>
                      </div>
                    </motion.a>
                ...
                <motion.div 
                  className="mt-6 sm:mt-8 bg-gradient-to-r from-skizen-accent/10 to-orange-500/10 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-skizen-accent/20"
                  initial={{ opacity: 0, y: 20 }}
                  animate={inView ? { opacity: 1, y: 0 } : {}}
                  transition={{ duration: 0.4, delay: 0.8 }}
                >
                  <h4 className="text-base sm:text-lg font-bold text-skizen-black mb-2 sm:mb-3">
                    Campaign Timeline
                  </h4>
