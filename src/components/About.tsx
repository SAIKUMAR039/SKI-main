...
import { Target, Zap, Rocket, User, Code, TrendingUp, Globe, Palette, DollarSign } from 'lucide-react';
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-3xl p-8 lg:p-10 border border-gray-200/50 shadow-lg hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center bg-gradient-to-r from-gray-50 to-white p-4 rounded-xl border border-gray-200/50 group-hover:border-ski-accent/30 transition-colors duration-300">
                        <div className="text-2xl font-bold text-ski-black mb-1">5+</div>
                        <div className="text-xs text-gray-500 font-medium">Years Experience</div>
                      </div>
                      <div className="text-center bg-gradient-to-r from-gray-50 to-white p-4 rounded-xl border border-gray-200/50 group-hover:border-ski-accent/30 transition-colors duration-300">
                        <div className="text-2xl font-bold text-ski-black mb-1">50+</div>
                        <div className="text-xs text-gray-500 font-medium">Projects Led</div>
                      </div>
                    </div>
                  </div>
